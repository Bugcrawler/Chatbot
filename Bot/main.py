...
def message_probability(user_message, recognised_words, single_response=False, required_words=[]):
    ...
    # Must either have teh required words, or be a single response
...
def check_all_messages(message):
    ...
    # Simplifies responses creation / adds it to the dict
    ...
    response('Thank you!', ['i', 'like', 'code', 'too'], required_words=['code', 'too'])
